...
def main():
    ...
    calib_loader, calib_limit, scheme = calibration_source(args, padded['train'], collate_padded)
    ...
    if args.gpxq != 'none':
        apply_gpxq(quantized, calib_loader, device, args.gpxq_batches, nclass, args.gpxq)
